...
g++ -DHAVE_CONFIG_H -I.  -I/opt/intel/sgxsdk/include -fno-builtin-memset -I/opt/openssl/1.1.0i/include   -std=c++11  -g   -MD -MP -MF .deps/client.Tpo -c -o ankr_client_sgx.o sgx_boinc_client.cpp

ar srv libankr_client_sgx.a  sgx_detect_linux.o sgx_stub.o quote_size.o byteorder.o common.o crypto.o hexutil.o fileio.o base64.o msgio.o logfile.o Enclave_u.o ankr_client_sgx.o

g++  -g  -L/opt/intel/sgxsdk/lib64 -L/opt/openssl/1.1.0i/lib  -o sgx_boinc_client_test ankr_service_provider/sgx_boinc_client_test.cpp libankr_client_sgx.a -lsgx_urts -lsgx_ukey_exchange -lsgx_uae_service -lcrypto -l:libsgx_capable.a -lpthread -ldl
