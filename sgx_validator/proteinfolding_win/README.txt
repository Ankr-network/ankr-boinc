...
Before you build
================
ProteinFolding App needs boost libraries (enclave does not need), you need to change your configuration like this,
in Addtional Include Directories, add something like below,
C:\work\boost_1_68_0\

in Additional Library Directories, add something like below,
C:\work\boost_1_68_0\stage\lib
